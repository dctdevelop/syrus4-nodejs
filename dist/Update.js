 ...
 */
function checkCore() {
    return Utils_1.default.OSExecute("apx-core-update", "check");
}
/**
 ...
 */
function updateOS() {
    return Utils_1.default.OSExecute("apx-os-update", "start");
}
/**
...
function installOS(package_name) {
    ...
    return Utils_1.default.OSExecute("apx-os-update", "install", package_name);
}
exports.default = {
    checkCore,
    UpdateCore,
